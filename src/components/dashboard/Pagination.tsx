    ...
    <div className="mt-4 flex items-center justify-between border-t border-border pt-4">
      ...
      <div className="flex gap-2">
        <button
          ...
          className="rounded-lg border border-border bg-surface-raised px-3 py-1.5 text-xs text-foreground transition-colors hover:border-burgundy/50 disabled:cursor-not-allowed disabled:opacity-40"
        >
          ‹ Prev
        </button>
        <button
